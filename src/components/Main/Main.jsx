...
const Main = () => {
  ...
  return (
    <div className='main'>
      <div className="nav">
        <p onClick={()=>newChat()}><span>Sage</span></p>
      ...
      <div className="main-container">
        ...
        <div className="main-bottom">
          ...
          <p className="bottom-info">
            Sage may display inaccurate info, including about people, so double-check its responses. Your privacy and Sage Apps
          </p>
        </div>
      </div>
    </div>
